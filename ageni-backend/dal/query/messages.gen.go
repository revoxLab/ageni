...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.BotID = field.NewInt64(tableName, "bot_id")
	...
	_message.ToolCall = field.NewString(tableName, "tool_call")
	_message.BackendToolCall = field.NewString(tableName, "backend_tool_call")
	_message.NextMsgIds = field.NewString(tableName, "next_msg_ids")
...
type message struct {
	...
	ToolCall        field.String
	BackendToolCall field.String
	NextMsgIds      field.String
	Status          field.Int32 // 0-default 1-success 2-fail
...
func (m *message) updateTableName(table string) *message {
	...
	m.BotID = field.NewInt64(table, "bot_id")
	...
	m.ToolCall = field.NewString(table, "tool_call")
	m.BackendToolCall = field.NewString(table, "backend_tool_call")
	m.NextMsgIds = field.NewString(table, "next_msg_ids")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["tool_call"] = m.ToolCall
	m.fieldMap["backend_tool_call"] = m.BackendToolCall
	m.fieldMap["next_msg_ids"] = m.NextMsgIds
